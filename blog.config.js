...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'A Simple Full-Stack Coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'unity,阿里云,typescript', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/tangly1024/limyoona900530', // 你的github个人主页 例如 https://github.com/tangly1024
